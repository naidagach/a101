...
function BrandSwiper() {
  ...
  return (
    <div className="px-[20px] py-[30px]">
      <div className='s:max-w-[1200px] mx-auto relative'>
        <button
          ref={prevRef}
        ...
        <button
          ref={nextRef}
          className="top-0 translate-0 w-[50px] h-[88px] flex items-center last-of-type:bg-gradient-to-l last-of-type:from-brand-gray-background last-of-type:justify-end first-of-type:bg-gradient-to-r first-of-type:from-brand-gray-background first-of-type:justify-start absolute z-[2] right-0"
          role="button">
          <div className="cursor-pointer">
            <svg
              width={24}
